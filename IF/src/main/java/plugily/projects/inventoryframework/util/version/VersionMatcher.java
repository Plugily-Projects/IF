...
import plugily.projects.inventoryframework.abstraction.*;
...
import plugily.projects.inventoryframework.nms.v1_15_R1.AnvilInventoryImpl;
import plugily.projects.inventoryframework.nms.v1_15_R1.BeaconInventoryImpl;
import plugily.projects.inventoryframework.nms.v1_15_R1.CartographyTableInventoryImpl;
import plugily.projects.inventoryframework.nms.v1_15_R1.EnchantingTableInventoryImpl;
import plugily.projects.inventoryframework.nms.v1_15_R1.GrindstoneInventoryImpl;
import plugily.projects.inventoryframework.nms.v1_15_R1.StonecutterInventoryImpl;
import plugily.projects.inventoryframework.nms.v1_16_R2.SmithingTableInventoryImpl;
...
public class VersionMatcher {
    ...
    public static AnvilInventory newAnvilInventory(@NotNull InventoryHolder inventoryHolder) {
        ...
        switch (minor) {
            case 14:
                return new plugily.projects.inventoryframework.nms.v1_14_R1.AnvilInventoryImpl(inventoryHolder);
            case 15:
    ...
    public static BeaconInventory newBeaconInventory(@NotNull InventoryHolder inventoryHolder) {
        ...
        switch (minor) {
            case 14:
                return new plugily.projects.inventoryframework.nms.v1_14_R1.BeaconInventoryImpl(inventoryHolder);
            case 15:
    ...
    public static CartographyTableInventory newCartographyTableInventory(@NotNull InventoryHolder inventoryHolder) {
        ...
        switch (minor) {
            case 14:
                return new plugily.projects.inventoryframework.nms.v1_14_R1.CartographyTableInventoryImpl(inventoryHolder);
            case 15:
    ...
    public static EnchantingTableInventory newEnchantingTableInventory(@NotNull InventoryHolder inventoryHolder) {
        ...
        switch (minor) {
            case 14:
                return new plugily.projects.inventoryframework.nms.v1_14_R1.EnchantingTableInventoryImpl(inventoryHolder);
            case 15:
    ...
    public static GrindstoneInventory newGrindstoneInventory(@NotNull InventoryHolder inventoryHolder) {
        ...
        switch (minor) {
            case 14:
                return new plugily.projects.inventoryframework.nms.v1_14_R1.GrindstoneInventoryImpl(inventoryHolder);
            case 15:
    ...
    public static SmithingTableInventory newSmithingTableInventory(@NotNull InventoryHolder inventoryHolder) {
        ...
        switch (minor) {
            case 16:
                if (micro == 1) {
                    return new plugily.projects.inventoryframework.nms.v1_16_R1.SmithingTableInventoryImpl(inventoryHolder);
                } else if (micro == 2) {
    ...
    public static StonecutterInventory newStonecutterInventory(@NotNull InventoryHolder inventoryHolder) {
        ...
        switch (minor) {
            case 14:
                return new plugily.projects.inventoryframework.nms.v1_14_R1.StonecutterInventoryImpl(inventoryHolder);
            case 15:
