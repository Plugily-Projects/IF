package plugily.projects.inventoryframework.gui.type;

import plugily.projects.inventoryframework.abstraction.SmithingTableInventory;
import plugily.projects.inventoryframework.gui.type.util.NamedGui;
import plugily.projects.inventoryframework.util.version.VersionMatcher;
...
public class SmithingTableGui extends NamedGui {
     ...
     */
    @NotNull
    private final SmithingTableInventory smithingTableInventory = VersionMatcher.newSmithingTableInventory(this
    );
